...
/***/ function(module, exports, __webpack_require__) {
	...
	var mergeProps = function mergeProps(stateProps, dispatchProps, ownProps) {
	  var selectImage = dispatchProps.selectImage;
	...
	var App = (0, _reactRedux.connect)(mapStateToProps, dispatchProps, mergeProps)(_App2.default);
	    ...
	    value: function render() {
	      ...
	      if (this.props.active) {
	        ...
	        instructions = _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'button',
	            { onClick: this.props.playAgain, className: 'Button' },
	            'Play again'
	          )
	        );
	      }
	        ...
	        _react2.default.createElement(
	          ...
	          this.props.urls.map(function (url, idx) {
	            return _react2.default.createElement(_ClickImage2.default, { url: url, key: idx, clicked: function clicked() {
	                return _this2.props.imageClicked(idx);
	              } });
	          })
	        )
	      );
...
/***/ function(module, exports) {
	...
	var generateCoords = function generateCoords(amount, currentLat, currentLong) {
	  ...
	  for (var i = 0; i < amount; i++) {
	    var lat = absRandom(MAX_LAT);
	    var long = absRandom(MAX_LONG);
	    coordAry.push({
	      lat: lat,
	      long: long,
	...
	var reducer = function reducer() {
	  ...
	  switch (action.type) {
	    ...
	    case 'PLAY_AGAIN':
	      var coords = generateCoords(NUM_PICS, state.lat, state.long);
