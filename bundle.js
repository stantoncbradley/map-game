...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapStateToProps = function mapStateToProps(state) {
	  return {
	    urls: state.coords.map(function (coord) {
	      return coord.url;
	    }),
	...
	var dispatchProps = function dispatchProps(dispatch) {
	  return {
	    ...
	    imageClicked: function imageClicked(index) {
	      dispatch((0, _actions.selectImage)(index));
	    }
	  };
	};
	
	var App = (0, _reactRedux.connect)(mapStateToProps, dispatchProps)(_App2.default);
...
/***/ function(module, exports) {
	...
	var setCoords = exports.setCoords = function setCoords(lat, long) {
	  return {
	    type: 'SET_COORDS',
	    lat: lat,
	    long: long
	...
	var noCoordsProvided = exports.noCoordsProvided = function noCoordsProvided() {
	  return {
	    type: 'NO_COORDS'
	  };
	};
	...
	var selectImage = exports.selectImage = function selectImage(number) {
	  debugger;
	  return {
	    type: 'IMAGE_SELECTED',
	    number: number
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ClickImage = __webpack_require__(193);
	
	var _ClickImage2 = _interopRequireDefault(_ClickImage);
	...
	var App = function (_React$Component) {
	  ...
	  function App() {
	    ...
	    if ("geolocation" in navigator) {
	      ...
	      _this.props.dispatch(noCoordsProvided());
	    }
	    return _this;
	  }
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          this.props.urls.map(function (url, idx) {
	            return _react2.default.createElement(_ClickImage2.default, { url: url, key: idx, clicked: function clicked() {
	                return self.props.imageClicked(idx);
	              } });
	          })
	        ),
	        _react2.default.createElement(
	...
	App.propTypes = {
	  urls: _react.PropTypes.arrayOf(_react.PropTypes.string).isRequired,
	  imageClicked: _react.PropTypes.func.isRequired,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ClickImage = function ClickImage(_ref) {
	  var url = _ref.url;
	  var clicked = _ref.clicked;
	  return _react2.default.createElement('img', { src: url, onClick: clicked });
	};
	
	ClickImage.propTypes = {
	  url: _react.PropTypes.string.isRequired,
	  clicked: _react.PropTypes.func.isRequired
	};
	
	exports.default = ClickImage;
...
/***/ function(module, exports) {
	...
	var maxLat = 90;
	var maxLong = 180;
	var googleMapsKey = 'AIzaSyDpPWpOoL02EV4l2GoFlhTxGGn2oBdenlw';
	...
	var absRandom = function absRandom(max) {
	...
	var getUrl = function getUrl(lat, long) {
	...
	var generateCoords = function generateCoords(amount, currentLat, currentLong) {
	  var coordAry = [];
	  var closest = Infinity;
	  for (var i = 0; i < amount; i++) {
	    var lat = absRandom(maxLat);
	    var long = absRandom(maxLong);
	    coordAry.push({
	      lat: lat,
	      long: long,
	...
	var reducer = function reducer() {
	  ...
	  switch (action.type) {
	    ...
	    case 'PLAY_AGAIN':
	      var coords = generateCoords(numPics, state.lat, state.long);
